...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row">
    <div class="w3-third">
      <img src="/pictures/1.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/2.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/3.jpg" style="width:100%" onclick="onClick(this)">
    </div>

    <div class="w3-third">
      <img src="/pictures/4.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/5.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/6.jpg" style="width:100%" onclick="onClick(this)">
    </div>
    
    <div class="w3-third">
      <img src="/pictures/7.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/8.jpg" style="width:100%" onclick="onClick(this)">
      <img src="/pictures/9.jpg" style="width:100%" onclick="onClick(this)">
    </div>
  </div>
